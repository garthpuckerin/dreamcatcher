    ...
    const sampleDreams = [
      {
        ...
        title: 'Dreamcatcher',
        description:
          'Consolidate scattered project ideas from multiple AI chat sessions into organized dreams',
        status: 'in-progress',
              ...
              <div key={dream.id} style={{ marginBottom: '0.5rem' }}>
                <div
                  style={{
                    padding: '1rem',
                    background:
                      selectedDream?.id === dream.id && !selectedFragment ? '#334155' : '#1e293b',
                    borderRadius: '8px',
                    cursor: 'pointer',
                    border: '1px solid',
                    borderColor:
                      selectedDream?.id === dream.id && !selectedFragment ? '#3b82f6' : '#334155',
                  }}
                >
                  <div
                    style={{
                ...
                {expandedDreams[dream.id] && (
                  <div style={{ marginLeft: '1.5rem', marginTop: '0.25rem' }}>
                    {dream.fragments.map(fragment => (
                      ...
                      >
                        <div
                          style={{ fontWeight: '500', color: '#cbd5e1', marginBottom: '0.25rem' }}
                        >
                          {fragment.title}
                        </div>
  ...
  return (
    <div>
      ...
      >
        <div>
          <h3
            style={{ fontSize: '1.5rem', fontWeight: '700', color: '#fff', marginBottom: '0.5rem' }}
          >
            {fragment.title}
          </h3>
