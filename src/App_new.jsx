    ...
    const sampleDreams = [
      {
        ...
        description: 'Complete launch strategy for Dreamcatcher v2.0, developed through AI conversation on Oct 11, 2025. Includes brand architecture, marketing strategy, roadmap, and PM feature expansion.',
        status: 'in-progress',
        ...
        summary: 'Strategic planning session that defined Dreamcatcher v2.0 launch, brand architecture (BC Innovations + BC Studio), and evolution from capture tool to full project management platform. Includes marketing strategy using 15+ real projects as proof, dog-fooding approach, and Supabase backend migration plan.',
        todos: [
          {
            id: 1001,
        ...
        fragments: [
          {
            ...
            content: 'Started with: "Help me finally launch Dreamcatcher". This began a 6-hour conversation that evolved into a complete strategic planning session.',
          ...
          },
          {
            ...
            content: 'Discovered the complete brand architecture: Blurred Concepts (parent) → BC Innovations (enterprise B2B: PipelineOS, Dreamcatcher, Connex, IPDE) + BC Studio (consumer B2C: MediaOS, ShadowSurf, ShadowStream - launching 2026).',
            source: 'Claude conversation - Oct 11, 2025',
          ...
          },
          {
            ...
            content: 'Revealed all projects from AI conversations: 3 in production (PipelineOS, Dreamcatcher, Builder Assistant), 5 in development (FortKnox, Connex, IPDE, Enterprise Suite, BC site), 7 in ideation (ShadowSurf, ShadowStream, MediaOS, etc.). This became the core marketing story.',
            source: 'Claude conversation - Oct 11, 2025',
          ...
          },
          {
            ...
            content: 'The origin story emerged: Started as "pipeline AI → notes" → Became PipelineOS (feature drift) → Full circle back to Dreamcatcher → Now they integrate. This narrative is gold.',
            source: 'Claude conversation - Oct 11, 2025',
          ...
          },
          {
            ...
            content: 'Defined what to reveal vs keep stealth: PUBLIC - BC Innovations products, PipelineOS, Dreamcatcher; TEASED - BC Studio (2026), more tools coming; STEALTH - Specific consumer products, Accordingto. Strategic transparency wins.',
            source: 'Claude conversation - Oct 11, 2025',
          ...
          },
          {
            ...
            content: 'Dreamcatcher evolved from capture tool to PROJECT MANAGEMENT: todos with deadlines, document attachments with AI parsing, task categorization (coding/admin/design/marketing), brand grouping, auto-completion via PipelineOS. This is the real vision.',
            source: 'Claude conversation - Oct 11, 2025',
            date: new Date('2025-10-11T18:00:00').toISOString(),
            features: ['project-management', 'todos', 'deadlines', 'document-parsing', 'brand-grouping'],
            codeSnippets: []
          },
          {
            id: 107,
            title: 'The Meta Moment',
            content: '"This entire chat is the perfect example of why I needed dreamcatcher in the first place." The conversation itself proves why Dreamcatcher exists. 6 hours, 15k+ lines, 9 strategic documents. Without Dreamcatcher: lost. With Dreamcatcher: organized forever.',
            source: 'Claude conversation - Oct 11, 2025',
          ...
          },
          {
            ...
            content: '"Shouldn\'t we be using our products to build our products?" YES! Use Dreamcatcher to manage this launch. Use PipelineOS agents to build v2.1-2.5 features. Use Builder Assistant to improve code. This is the complete loop in action.',
            source: 'Claude conversation - Oct 11, 2025',
          ...
          },
          {
            ...
            content: 'LocalStorage isn\'t enough for PM features. Decision: Supabase for backend (PostgreSQL, storage, auth, realtime). Launch v2.0 with LocalStorage Oct 17, add Supabase backend Oct 24. Stay the course, iterate fast.',
            source: 'Claude conversation - Oct 11, 2025',
      ...
      },
      {
        ...
        description: 'The Dreamcatcher product itself - consolidate scattered project ideas from multiple AI chat sessions into organized dreams',
        status: 'in-progress',
        brand: 'bc-innovations',
        tags: ['productivity', 'ai', 'web-app'],
        created: new Date('2025-01-08').toISOString(),
        updated: new Date().toISOString(),
        summary: 'Core product for capturing and organizing AI conversation fragments into consolidated project dreams.',
        todos: [],
        documents: [],
        fragments: [
          {
      ...
      },
      {
        ...
        summary: 'Completed resume generator with multiple styles (Classic, Modern, Minimal) and PDF export functionality.',
        todos: [],
        documents: [],
        fragments: [
          {
  ...
  const filteredAndSortedDreams = () => {
    let filtered = dreams.filter(dream => {
      ...
      const matchesTags = filterTags.length === 0 || 
        filterTags.some(tag => dream.tags.includes(tag));
    ...
    <div style={{ display: 'flex', height: '100vh', background: '#0f172a', color: '#e2e8f0', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div style={{ width: '280px', background: '#1e293b', borderRight: '1px solid #334155', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ padding: '1rem', borderBottom: '1px solid #334155' }}>
          <button 
            onClick={() => { setMainView('all-dreams'); setSelectedDream(null); setSelectedFragment(null); }}
            style={{ 
              width: '100%',
              padding: '0.75rem',
        ...
        <div style={{ padding: '1rem', display: 'flex', gap: '0.5rem', borderBottom: '1px solid #334155' }}>
          <button onClick={() => setShowNewDream(true)} style={{ flex: 1, padding: '0.625rem', background: '#10b981', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', fontSize: '0.875rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}>
            <Plus size={16} /> New
          </button>
          <input
            type="file"
        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '0.5rem' }}>
          <div style={{ padding: '0.75rem 0.5rem 0.5rem', fontSize: '0.75rem', fontWeight: '600', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          {getRecentDreamsList().length === 0 ? (
            ...
            getRecentDreamsList().map(dream => (
              <div
                ...
                onMouseLeave={(e) => e.currentTarget.style.borderColor = selectedDream?.id === dream.id ? '#3b82f6' : '#1e293b'}
              >
                <div style={{ fontWeight: '600', color: '#fff', marginBottom: '0.25rem', fontSize: '0.9rem' }}>{dream.title}</div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        {mainView === 'all-dreams' ? (
          ...
          <DreamDetailView
            ...
            onSelectFragment={(frag) => { setSelectedFragment(frag); setMainView('fragment-detail'); }}
...
function AllDreamsView({ dreams, searchQuery, setSearchQuery, filterStatus, setFilterStatus, filterBrand, setFilterBrand, filterTags, toggleTagFilter, allTags, sortBy, setSortBy, statuses, brands, onSelectDream }) {
  return (
    <>
      <div style={{ padding: '1.5rem 2rem', borderBottom: '1px solid #334155' }}>
        <h2 style={{ fontSize: '2rem', fontWeight: '700', marginBottom: '1rem', color: '#fff' }}>
          All Dreams
          <span style={{ fontSize: '1.25rem', fontWeight: '400', color: '#64748b', marginLeft: '1rem' }}>
        ...
        {allTags.length > 0 && (
          <div style={{ marginTop: '1rem' }}>
            <div style={{ fontSize: '0.8rem', fontWeight: '600', color: '#64748b', marginBottom: '0.5rem' }}>Filter by tags:</div>
            ...
            {dreams.map(dream => (
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '0.75rem' }}>
                  <div style={{ flex: 1 }}>
                    <h3 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#fff', marginBottom: '0.25rem' }}>{dream.title}</h3>
                    {dream.brand && (
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.25rem', fontSize: '0.75rem', color: brands.find(b => b.value === dream.brand)?.color }}>
                ...
                <p style={{ fontSize: '0.9rem', color: '#94a3b8', marginBottom: '1rem', lineHeight: '1.5', flex: 1 }}>
                  {dream.description}
                </p>
                ...
                {dream.tags.length > 0 && (
                  <div style={{ display: 'flex', gap: '0.375rem', flexWrap: 'wrap', marginBottom: '1rem' }}>
                    {dream.tags.map(tag => (
                      <span key={tag} style={{ padding: '0.25rem 0.5rem', background: '#0f172a', borderRadius: '4px', fontSize: '0.75rem', color: '#64748b' }}>
                        {tag}
                      </span>
                    ))}
                  </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.8rem', color: '#64748b', paddingTop: '0.75rem', borderTop: '1px solid #334155', flexWrap: 'wrap', gap: '0.5rem' }}>
                  ...
                  {dream.todos && dream.todos.length > 0 && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.375rem' }}>
                      <CheckSquare size={14} />
                      <span>{dream.todos.filter(t => t.completed).length}/{dream.todos.length} todos</span>
                    </div>
                  )}
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.375rem' }}>
                    <Calendar size={14} />
...
function DreamDetailView({ dream, dreamView, setDreamView, isEditing, setIsEditing, onUpdateDream, onDeleteDream, onSelectFragment, onAddFragment, statuses, getAllFeatures, setMainView }) {
  return (
    <>
      <div style={{ padding: '1.5rem 2rem', borderBottom: '1px solid #334155' }}>
        {/* Breadcrumb */}
        <div style={{ fontSize: '0.85rem', color: '#64748b', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          <button 
            ...
            style={{ background: 'none', border: 'none', color: '#3b82f6', cursor: 'pointer', padding: 0, fontSize: '0.85rem' }}
          >
            All Dreams
          </button>
          <span>/</span>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
          <div style={{ flex: 1 }}>
            <h2 style={{ fontSize: '2rem', fontWeight: '700', marginBottom: '0.5rem', color: '#fff' }}>{dream.title}</h2>
          ...
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            ...
            <button onClick={() => onDeleteDream(dream.id)} style={{ padding: '0.5rem 1rem', background: '#1e293b', color: '#ef4444', border: '1px solid #334155', borderRadius: '6px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <Trash2 size={16} />
            </button>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
          ...
          >
            <ListTodo size={16} /> Todos {dream.todos && dream.todos.length > 0 && `(${dream.todos.filter(t => t.completed).length}/${dream.todos.length})`}
          </button>
          <button 
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '2rem' }}>
        {isEditing ? (
          ...
          <FragmentsView dream={dream} onSelectFragment={onSelectFragment} onAddFragment={onAddFragment} />
        )}
      </div>
    </>
  );
...
function SummaryView({ dream, statuses }) {
  ...
  const overdueTodos = dream.todos ? dream.todos.filter(t => !t.completed && new Date(t.deadline) < new Date()).length : 0;
  const upcomingTodos = dream.todos ? dream.todos.filter(t => !t.completed && new Date(t.deadline) >= new Date() && new Date(t.deadline) <= new Date(Date.now() + 7 * 24 * 60 * 60 * 1000)).length : 0;
    ...
    <div>
      ...
      {dream.summary && (
        <div style={{ marginBottom: '2rem' }}>
          <h3 style={{ fontSize: '1.25rem', fontWeight: '600', color: '#fff', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <FileText size={20} /> Dream Summary
          </h3>
          <div style={{ padding: '1.5rem', background: '#1e293b', borderRadius: '8px', border: '1px solid #334155', fontSize: '0.95rem', lineHeight: '1.7', color: '#cbd5e1' }}>
            {dream.summary}
          </div>
        </div>
      )}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem', marginBottom: '2rem' }}>
        {/* Status */}
        <div style={{ padding: '1.5rem', background: '#1e293b', borderRadius: '8px', border: '1px solid #334155' }}>
          <div style={{ fontSize: '0.8rem', fontWeight: '600', color: '#64748b', marginBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Status</div>
          <div style={{ 
        ...
        {dream.brand && (
          <div style={{ padding: '1.5rem', background: '#1e293b', borderRadius: '8px', border: '1px solid #334155' }}>
            <div style={{ fontSize: '0.8rem', fontWeight: '600', color: '#64748b', marginBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Brand</div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.95rem', color: brands.find(b => b.value === dream.brand)?.color, fontWeight: '600' }}>
              <span style={{ fontSize: '1.5rem' }}>{brands.find(b => b.value === dream.brand)?.icon}</span>
              <span>{brands.find(b => b.value === dream.brand)?.label}</span>
            </div>
          </div>
        )}
        ...
        {/* Fragments */}
        <div style={{ padding: '1.5rem', background: '#1e293b', borderRadius: '8px', border: '1px solid #334155' }}>
          <div style={{ fontSize: '0.8rem', fontWeight: '600', color: '#64748b', marginBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Fragments</div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            <Layers size={24} color="#3b82f6" />
            <span style={{ fontSize: '1.5rem', fontWeight: '700', color: '#fff' }}>{dream.fragments.length}</span>
          </div>
        </div>
        ...
        {totalTodos > 0 && (
          <div style={{ padding: '1.5rem', background: '#1e293b', borderRadius: '8px', border: '1px solid #334155' }}>
            <div style={{ fontSize: '0.8rem', fontWeight: '600', color: '#64748b', marginBottom: '0.5rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Todo Progress</div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              <div style={{ flex: 1 }}>
                ...
                <div style={{ height: '8px', background: '#0f172a', borderRadius: '4px', overflow: 'hidden' }}>
                  <div style={{ height: '100%', background: progressPercent === 100 ? '#10b981' : '#3b82f6', width: `${progressPercent}%`, transition: 'width 0.3s' }} />
                </div>
              </div>
      ...
      {(overdueTodos > 0 || upcomingTodos > 0) && (
        <div style={{ marginBottom: '2rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            {overdueTodos > 0 && (
              <div style={{ padding: '1rem', background: '#7f1d1d20', border: '1px solid #ef4444', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                <AlertCircle size={20} color="#ef4444" />
                <div>
                  <div style={{ fontWeight: '600', color: '#ef4444', marginBottom: '0.25rem' }}>Overdue Tasks</div>
                  <div style={{ fontSize: '0.85rem', color: '#fca5a5' }}>{overdueTodos} todo{overdueTodos !== 1 ? 's' : ''} past deadline</div>
                </div>
              </div>
            )}
            {upcomingTodos > 0 && (
              <div style={{ padding: '1rem', background: '#78350f20', border: '1px solid #f59e0b', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                <Calendar size={20} color="#f59e0b" />
                <div>
                  <div style={{ fontWeight: '600', color: '#f59e0b', marginBottom: '0.25rem' }}>Upcoming Deadlines</div>
                  <div style={{ fontSize: '0.85rem', color: '#fbbf24' }}>{upcomingTodos} todo{upcomingTodos !== 1 ? 's' : ''} due within 7 days</div>
                </div>
              </div>
            )}
          </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1rem' }}>
        <div style={{ padding: '1rem', background: '#1e293b', borderRadius: '8px', border: '1px solid #334155' }}>
          ...
          <div style={{ fontSize: '0.9rem', color: '#e2e8f0' }}>{new Date(dream.created).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</div>
        </div>
        <div style={{ padding: '1rem', background: '#1e293b', borderRadius: '8px', border: '1px solid #334155' }}>
          <div style={{ fontSize: '0.75rem', color: '#64748b', marginBottom: '0.25rem' }}>Last Updated</div>
          <div style={{ fontSize: '0.9rem', color: '#e2e8f0' }}>{new Date(dream.updated).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</div>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
        <h3 style={{ fontSize: '1.2rem', fontWeight: '600', color: '#fff', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          <ListTodo size={24} /> Todos {todos.length > 0 && `(${completedTodos.length}/${todos.length})`}
        </h3>
        <button 
          onClick={() => setShowNewTodo(true)}
          style={{ padding: '0.625rem 1.25rem', background: '#3b82f6', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '0.875rem', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '0.5rem' }}
        >
      ...
      {activeTodos.length > 0 && (
        <div style={{ marginBottom: '2rem' }}>
          <h4 style={{ fontSize: '0.875rem', fontWeight: '600', color: '#64748b', marginBottom: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Active ({activeTodos.length})</h4>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            {activeTodos.map(todo => (
              <div 
                ...
                style={{ 
                  ...
                  borderRadius: '8px', 
                  border: '1px solid',
                  borderColor: isOverdue(todo.deadline) ? '#ef4444' : isUpcoming(todo.deadline) ? '#f59e0b' : '#334155'
                }}
              >
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem', flexWrap: 'wrap' }}>
                      <h5 style={{ fontSize: '1rem', fontWeight: '600', color: '#fff', margin: 0 }}>{todo.title}</h5>
                      <span style={{ 
                        padding: '0.25rem 0.625rem', 
                        borderRadius: '4px', 
                        fontSize: '0.75rem', 
                        fontWeight: '600',
                        background: taskCategories.find(c => c.value === todo.category)?.color + '20',
                    ...
                    {todo.notes && (
                      <p style={{ fontSize: '0.875rem', color: '#94a3b8', marginBottom: '0.5rem', lineHeight: '1.5' }}>{todo.notes}</p>
                    )}
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', fontSize: '0.8rem' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.375rem', color: isOverdue(todo.deadline) ? '#ef4444' : isUpcoming(todo.deadline) ? '#f59e0b' : '#64748b' }}>
                        <Calendar size={14} />
                        <span>{new Date(todo.deadline).toLocaleDateString()}</span>
                        {isOverdue(todo.deadline) && <span style={{ fontWeight: '600' }}>(Overdue)</span>}
                        {isUpcoming(todo.deadline) && <span style={{ fontWeight: '600' }}>(Upcoming)</span>}
                      </div>
                    </div>
                  </div>
                  <div style={{ display: 'flex', gap: '0.5rem' }}>
                    <button
                      ...
                      style={{ padding: '0.375rem', background: '#0f172a', border: '1px solid #334155', borderRadius: '4px', cursor: 'pointer', color: '#94a3b8' }}
                    >
                      <Edit2 size={14} />
                    </button>
                    <button
                      onClick={() => deleteTodo(todo.id)}
                      style={{ padding: '0.375rem', background: '#0f172a', border: '1px solid #334155', borderRadius: '4px', cursor: 'pointer', color: '#ef4444' }}
                    >
                      <Trash2 size={14} />
                    </button>
                  </div>
      ...
      {completedTodos.length > 0 && (
        <div>
          <h4 style={{ fontSize: '0.875rem', fontWeight: '600', color: '#64748b', marginBottom: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Completed ({completedTodos.length})</h4>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            {completedTodos.map(todo => (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem', flexWrap: 'wrap' }}>
                      <h5 style={{ fontSize: '1rem', fontWeight: '600', color: '#64748b', margin: 0, textDecoration: 'line-through' }}>{todo.title}</h5>
                      <span style={{ 
                        padding: '0.25rem 0.625rem', 
                        borderRadius: '4px', 
                        fontSize: '0.75rem', 
                    ...
                    {todo.notes && (
                      <p style={{ fontSize: '0.875rem', color: '#64748b', marginBottom: '0.5rem', lineHeight: '1.5', textDecoration: 'line-through' }}>{todo.notes}</p>
                    )}
                  </div>
                  <button
                    onClick={() => deleteTodo(todo.id)}
                    style={{ padding: '0.375rem', background: 'transparent', border: '1px solid #334155', borderRadius: '4px', cursor: 'pointer', color: '#64748b' }}
                  >
                    <Trash2 size={14} />
                  </button>
                </div>
      ...
      {(showNewTodo || editingTodo) && (
        <Modal onClose={() => { setShowNewTodo(false); setEditingTodo(null); }}>
          ...
          <TodoForm
            ...
            onCancel={() => { setShowNewTodo(false); setEditingTodo(null); }}
    ...
    <>
      <div style={{ padding: '1.5rem 2rem', borderBottom: '1px solid #334155' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          ...
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            <button onClick={onDelete} style={{ padding: '0.5rem 1rem', background: '#1e293b', color: '#ef4444', border: '1px solid #334155', borderRadius: '6px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
...
function TodoForm({ todo, onSave, onCancel, taskCategories }) {
  ...
  return (
    <div>
      <div style={{ marginBottom: '1.5rem' }}>
        <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.875rem', fontWeight: '600', color: '#94a3b8' }}>Todo Title *</label>
        <input
          type="text"
          value={formData.title}
          onChange={(e) => setFormData({ ...formData, title: e.target.value })}
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.875rem', fontWeight: '600', color: '#94a3b8' }}>Category *</label>
        <select
          value={formData.category}
          onChange={(e) => setFormData({ ...formData, category: e.target.value })}
          style={{ width: '100%', padding: '0.75rem', background: '#0f172a', border: '1px solid #334155', borderRadius: '8px', color: '#e2e8f0', fontSize: '0.95rem', cursor: 'pointer' }}
        >
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.875rem', fontWeight: '600', color: '#94a3b8' }}>Deadline *</label>
        <input
          type="date"
      ...
      <div style={{ marginBottom: '1.5rem' }}>
        <label style={{ display: 'block', marginBottom: '0.5rem', fontSize: '0.875rem', fontWeight: '600', color: '#94a3b8' }}>Notes (optional)</label>
        <textarea
      ...
      <div style={{ display: 'flex', gap: '0.75rem' }}>
        <button 
          ...
          style={{ flex: 1, padding: '0.875rem', background: '#3b82f6', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', fontSize: '1rem' }}
        >
          <Save size={18} style={{ verticalAlign: 'middle', marginRight: '0.5rem' }} />
          Save Todo
        </button>
        <button 
          onClick={onCancel}
          style={{ padding: '0.875rem 1.5rem', background: '#1e293b', color: '#94a3b8', border: '1px solid #334155', borderRadius: '8px', cursor: 'pointer', fontWeight: '600' }}
        >
          Cancel
        </button>
      </div>
