...
describe('AIAssistantService', () => {
  ...
  describe('Progress Summarization', () => {
    it('should generate weekly progress summary', async () => {
      ...
      const mockResponse = {
        choices: [{ message: { content: 'This week: Designed UI and implemented authentication.' } }]
      };
  ...
  describe('Risk Detection', () => {
    it('should detect scope creep', async () => {
      ...
      const mockResponse = {
        choices: [{
          message: {
            content: 'WARNING: Scope creep detected. Original goal was simple CRUD, but adding complex features.'
          }
        }]
      };
  ...
  describe('Code Analysis', () => {
    it('should analyze code snippets for features', async () => {
      ...
      const mockResponse = {
        choices: [{
          message: {
            content: 'Features detected: Authentication system (JavaScript), Email functionality (Python)'
          }
        }]
      };
