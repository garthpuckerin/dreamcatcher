...
describe('TemplateService', () => {
    ...
    it('should validate required fields', () => {
      expect(() => {
        templateService.createTemplate(
          null,
          [],
          { name: 'Test', category: 'project', author: 'user' }
        );
      }).toThrow();
      ...
      expect(() => {
        templateService.createTemplate(
          { title: 'Test', tags: [] },
          [],
          { description: 'Test', category: 'project', author: 'user' }
        );
      }).toThrow();
    });
  });
  ...
  describe('Template Filtering', () => {
    ...
    it('should filter by category', () => {
      const productTemplates = templateService.getTemplates().filter(
        t => t.category === 'product'
      );
      const personalTemplates = templateService.getTemplates().filter(
