...
class ConversationCapture {
    ...
    generateTags(text) {
        ...
        if (textLower.includes('react'))
            tags.push('react');
        if (textLower.includes('vue'))
            tags.push('vue');
        if (textLower.includes('angular'))
            tags.push('angular');
        if (textLower.includes('node'))
            tags.push('nodejs');
        if (textLower.includes('python'))
            tags.push('python');
        if (textLower.includes('javascript'))
            tags.push('javascript');
        if (textLower.includes('typescript'))
            tags.push('typescript');
        if (textLower.includes('sql'))
            tags.push('database');
        if (textLower.includes('api'))
            tags.push('api');
        if (textLower.includes('frontend'))
            tags.push('frontend');
        if (textLower.includes('backend'))
            tags.push('backend');
        if (textLower.includes('fullstack'))
            tags.push('fullstack');
        // Project type tags
        if (textLower.includes('web app'))
            tags.push('web-app');
        if (textLower.includes('mobile app'))
            tags.push('mobile-app');
        if (textLower.includes('desktop app'))
            tags.push('desktop-app');
        if (textLower.includes('ecommerce'))
            tags.push('ecommerce');
